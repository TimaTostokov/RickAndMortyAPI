...
import com.example.my.rickandmortyapi.domain.usecases.RickAndMortyUseCase
...
@HiltViewModel
class RickAndMortyViewModel @Inject constructor(private val useCase: RickAndMortyUseCase) :
    ViewModel() {
        ...
        useCase().collect {
            when (it) {
                is Resource.Success -> _state.value =
                    RickAndMortyStates(success = it.data ?: emptyList())
